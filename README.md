...
> Tailwind, React, repeat. A boilerplate to build a React component library.
...
```bash
$ git clone https://github.com/absolutezeroo/tailwind-react-ui-components cool-name
$ cd cool-name
$ rm -rf .git
$ git init
```
...
Tailwind React is currently using the latest technology available, so you may need to update your Node versions to latest to accomodate Babel 7 and Webpack 4.
