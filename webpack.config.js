...
module.exports = {
	...
	module: {
		...
		rules: [
			...
			{
				// I haven't used CSS in the base example, but it's here for you if
				// you
				// want! If you want to use CSS, you can change this next like's regex
				// to /\.(css|scss)$/ or even just /\.css$/
				test: /\.css$/,
				use: [
	...
	// dist is a common output folder, and it should be git ignored. The build can
	...
	output: {
		...
		filename: 'index.js',
		// This field determines how things are importable when installed from
		// other
		// sources. UMD may not be correct now and there is an open issue to fix
		// this, but until then, more reading can be found here:
